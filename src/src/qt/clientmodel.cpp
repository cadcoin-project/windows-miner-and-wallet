...
// CHNCoin: copied from bitcoinrpc.cpp.
...
QDateTime ClientModel::getLastBlockDate() const
{
    if (pindexBest)
        ...
        return QDateTime::fromTime_t(1585816382); // Genesis block's time
    else
        return QDateTime::fromTime_t(1585816393); // Genesis block's time (testnet)
}

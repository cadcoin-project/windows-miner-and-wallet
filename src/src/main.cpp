...
uint256 hashGenesisBlock("9ef83c23ece4e5860cc744d2e552ce78e75af3f622aee8cb6c973df86185fa9c");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 750000); // Cadcoin: 750k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1.5 * 24 * 60 * 60; // Cadcoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Cadcoin: 5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("77ffe284239ca81f86d7b5cb0528cdd5c6f896083ff73a6483f186f26ad68b6f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "COVID 19 hits South africa";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0417cd8df1e61cd27e4ef28efcf101e120dbbd5cb7e78cf5633b42565b96aae28890de27c866edb92f388a8ab499ac830ad1e5ddd30b4815043928637cfbd4acd9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1585816382;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085711914;

        if (fTestNet)
        {
            block.nTime    = 1585816393;
            block.nNonce   = 385690816;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("a2af884a17b01316bdb70e007450c352c46b092850a4caa5fe1a8ee1ae273eec"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc2, 0xba, 0xd3 }; // Cadcoin: increase each by adding 2 to bitcoin's value.
